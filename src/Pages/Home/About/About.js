        ...
        <div className="hero my-20">
            <div className="hero-content flex-col lg:flex-row">
                <div className='relative w-1/2 mr-5'>
                    ...
                    <img src={parts} alt='' className=" border-4 border-white absolute w-3/5 top-1/2 right-8 rounded-lg shadow-2xl" />
                </div>
                <div className='w-1/2'>
                    <h3 className='text-xl font-bold pb-5' style={{ color: '#FF3811' }}>About Us</h3>
                    ...
                    <button className="btn btn-custom">Get More Info</button>
                </div>
            </div>
        </div>
    );
